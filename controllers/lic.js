...
const { save: saveSchema, getDetails: getDetailsSchema, patch: patchSchema } = require('../dto-schemas/lic');
...
const save = async (req, res) => {
  try {
    ...
    const { errors: err, doc } = await LicService.save(data);
...
const getAll = async (req, res) => {
  try {
    ...
    const { count, doc } = await LicService.getAll({ userId });
...
const getDetailById = async (req, res) => {
  try {
    ...
    const { doc } = await LicService.getDetailById(data);
